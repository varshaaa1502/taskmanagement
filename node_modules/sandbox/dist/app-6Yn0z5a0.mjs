...
import fs$1, { mkdirSync, readFileSync, writeFileSync } from "node:fs";
...
import { APIError, DEFAULT_SANDBOX_REGION, Sandbox, Snapshot, StreamError } from "@vercel/sandbox";
...
var require_type = /* @__PURE__ */ __commonJS({ "../../node_modules/.pnpm/cmd-ts@0.15.0/node_modules/cmd-ts/dist/cjs/type.js": ((exports) => {
	...
	*/
	function extendType$2(base$2, nextTypeOrDecodingFunction) {
		const { defaultValue: _defaultValue, onMissing: _onMissing, from: _from, ...t1WithoutDefault } = base$2;
		...
		return {
			...
			...t2Object,
			async from(a) {
				return await t2From(await base$2.from(a));
			}
		};
	}
}) });
...
const runtime = import_cjs$32.option({
	long: "runtime",
	description: "Deprecated. Use --image instead.",
	type: import_cjs$32.optional(runtimeType)
});

//#endregion
//#region src/types/duration.ts
var import_cjs$31 = require_cjs();
init_source();
const Duration = (0, import_cjs$31.extendType)(import_cjs$31.string, {
...
const timeout = import_cjs$30.option({
	long: "timeout",
	type: Duration,
...
const vcpusType = import_cjs$29.extendType(import_cjs$29.number, {
	displayName: "COUNT",
	async from(n) {
...
const vcpus = import_cjs$29.option({
	long: "vcpus",
	type: import_cjs$29.optional(vcpusType),
...
const login = import_cjs$28.command({
	name: "login",
...
const token = import_cjs$27.option({
	long: "token",
...
const project = import_cjs$26.option({
	long: "project",
	type: {
		...import_cjs$26.optional(import_cjs$26.string),
...
const teamParser = import_cjs$26.option({
	long: "team",
	type: {
		...import_cjs$26.optional(import_cjs$26.string),
		displayName: "my-team"
...
const scopeParser = import_cjs$26.option({
	long: "scope",
	type: {
		...import_cjs$26.optional(import_cjs$26.string),
		displayName: "my-team"
...
async function formatApiError(error) {
	...
	const message = ApiErrorResponse.safeParse(error.json).data?.error.message ?? getErrorMessage(status);
	const isLookupMiss = status === 404 && /\/sandboxes\//.test(error.response.url);
	if (isLookupMiss && !debug$3.enabled) {
		debug$3(`requested url: ${error.response.url}`);
		return new StyledError([
			message,
			`├▶ status code: ${status} ${error.response.statusText}`,
			`╰▶ ${source_default.bold("hint:")} run ${source_default.cyan("sandbox ls --all")} to see the sandboxes in this project.`
		].join("\n"), error);
	}
	...
	if (isLookupMiss) lines.push(`├▶ ${source_default.bold("hint:")} run ${source_default.cyan("sandbox ls --all")} to see the sandboxes in this project.`);
	lines.push(`╰▶ ${source_default.bold("hint:")} the full response buffer is stored in ${source_default.italic(tmpPath)}`);
...
init_source();
const snapshotId = import_cjs$25.extendType(import_cjs$25.string, {
...
init_source();
const publishPorts = import_cjs$24.multioption({
	long: "publish-port",
	short: "p",
	description: "Publish sandbox port(s) to DOMAIN.vercel.run",
	type: import_cjs$24.array(import_cjs$24.extendType(import_cjs$24.number, {
		displayName: "PORT",
		async from(number) {
...
const SnapshotExpiration = (0, import_cjs$23.extendType)(import_cjs$23.string, {
...
const snapshotExpiration = import_cjs$22.option({
	long: "snapshot-expiration",
	type: import_cjs$22.optional(SnapshotExpiration),
	description: "Default snapshot expiration. Use \"none\" or 0 for no expiration. Example: 7d, 30d"
});
const keepLastSnapshots = import_cjs$22.option({
	long: "keep-last-snapshots",
	type: import_cjs$22.optional(import_cjs$22.extendType(import_cjs$22.number, {
		displayName: "COUNT",
		async from(n) {
...
const keepLastSnapshotsFor = import_cjs$22.option({
...
const deleteEvictedSnapshots = import_cjs$22.option({
	long: "delete-evicted-snapshots",
	type: import_cjs$22.optional({
		...import_cjs$22.oneOf(["true", "false"]),
		displayName: "true|false"
	}),
...
init_source();
const sandboxName = import_cjs$21.extendType(import_cjs$21.string, {
	displayName: "name",
...
init_source();
const KeyValuePair = import_cjs$20.extendType(import_cjs$20.string, {
...
const ObjectFromKeyValue = import_cjs$20.extendType(import_cjs$20.array(KeyValuePair), { async from(input) {
...
init_source();
const args$4 = {
	sandbox: import_cjs$19.positional({ type: sandboxName }),
	command: import_cjs$19.positional({
		displayName: "command",
		description: "The executable to invoke"
	}),
	args: import_cjs$19.rest({
		displayName: "args",
		description: "arguments to pass to the command"
	}),
	asSudo: import_cjs$19.flag({
		long: "sudo",
		description: "Give extended privileges to the command."
	}),
	interactive: import_cjs$19.flag({
		long: "interactive",
		short: "i",
		description: "Run the command in a secure interactive shell",
		type: import_cjs$19.extendType(import_cjs$19.boolean, {
			defaultValue() {
				return false;
			},
			async from(input) {
	...
	skipExtendingTimeout: import_cjs$19.flag({
	...
	tty: import_cjs$19.flag({
		long: "tty",
		short: "t",
		description: "Allocate a tty for an interactive command. This is a no-op."
	}),
	cwd: import_cjs$19.option({
		long: "workdir",
		short: "w",
		description: "The working directory to run the command in",
		type: import_cjs$19.optional(import_cjs$19.string)
	}),
	envVars: import_cjs$19.multioption({
		long: "env",
		short: "e",
		type: ObjectFromKeyValue,
		description: "Environment variables to set for the command"
	}),
	timeout: import_cjs$19.option({
		long: "timeout",
		type: import_cjs$19.optional(Duration),
...
const exec = import_cjs$19.command({
	name: "exec",
...
init_source();
const networkPolicyMode = import_cjs$18.extendType(import_cjs$18.string, {
	displayName: "MODE",
	async from(value) {
...
const networkPolicy = import_cjs$18.option({
	long: "network-policy",
	...
	type: import_cjs$18.optional(networkPolicyMode)
});
const allowedDomains = import_cjs$18.multioption({
	long: "allowed-domain",
	...
	type: import_cjs$18.array(import_cjs$18.string)
});
const allowedCIDRs = import_cjs$18.multioption({
	long: "allowed-cidr",
	description: `CIDR to allow traffic to (creates a custom network policy). Takes precedence over 'allowed-domain'.`,
	type: import_cjs$18.array(import_cjs$18.string)
});
const deniedCIDRs = import_cjs$18.multioption({
	long: "denied-cidr",
...
function printSandboxSummary(opts) {
	const { sandbox, scope: scope$1, action, connectHint } = opts;
	...
	process.stderr.write(source_default.dim("   │ ") + "region: " + source_default.cyan(sandbox.region) + "\n");
	const close = (last) => source_default.dim(last && !connectHint ? "   ╰ " : "   │ ");
	if (hasPorts) {
		...
		for (let i = 0; i < routes.length; i++) {
			...
			process.stderr.write(close(isLast) + "• " + route.port + " -> " + source_default.cyan(route.url) + "\n");
		}
	} else process.stderr.write(close(true) + "project: " + source_default.cyan(projectDisplay) + "\n");
	if (connectHint) process.stderr.write(source_default.dim("   ╰ ") + "connect with: " + source_default.cyan(`sandbox ssh ${sandbox.name}`) + "\n");
}

//#endregion
//#region ../../node_modules/.pnpm/os-paths@4.4.0/node_modules/os-paths/src/lib/index.js
var require_lib$1 = /* @__PURE__ */ __commonJS({ "../../node_modules/.pnpm/os-paths@4.4.0/node_modules/os-paths/src/lib/index.js": ((exports, module) => {
	const os$2 = __require("os");
	const paths = __require("path");
	const isWinOS$1 = /^win/i.test(process.platform);
	function normalize_path(path$2) {
		return paths.normalize(paths.join(path$2, "."));
	}
	const base$1 = () => {
		const { env: env$2 } = process;
		const object = {};
		object.home = () => normalize_path(os$2.homedir ? os$2.homedir() : env$2.HOME);
		object.temp = () => normalize_path(os$2.tmpdir ? os$2.tmpdir() : env$2.TMPDIR || env$2.TEMP || env$2.TMP);
		return object;
	};
	const windows$2 = () => {
		const { env: env$2 } = process;
		const object = {};
		object.home = () => normalize_path(os$2.homedir ? os$2.homedir() : env$2.USERPROFILE || paths.join(env$2.HOMEDRIVE, env$2.HOMEPATH) || env$2.HOME);
		object.temp = () => normalize_path(os$2.tmpdir ? os$2.tmpdir() : env$2.TEMP || env$2.TMP || paths.join(env$2.LOCALAPPDATA || env$2.SystemRoot || env$2.windir, "Temp"));
		return object;
	};
	var _OSPaths = class _OSPaths {
		constructor() {
			const OSPaths = function() {
				return new _OSPaths();
			};
			this._fn = OSPaths;
			const extension = isWinOS$1 ? windows$2() : base$1();
...
var require_lib = /* @__PURE__ */ __commonJS({ "../../node_modules/.pnpm/xdg-portable@7.3.0/node_modules/xdg-portable/src/lib/index.js": ((exports, module) => {
	const path$1 = __require("path");
	const osPaths = require_lib$1();
	const linux = () => {
		const object = {};
	...
	const _XDGPortable = () => {
		...
		else if (/^win/i.test(process.platform)) extension = windows$1();
...
//#endregion
//#region ../../node_modules/.pnpm/xdg-app-paths@5.1.0/node_modules/xdg-app-paths/index.js
var require_xdg_app_paths = /* @__PURE__ */ __commonJS({ "../../node_modules/.pnpm/xdg-app-paths@5.1.0/node_modules/xdg-app-paths/index.js": ((exports, module) => {
	const path = __require("path");
	const os$1 = __require("os");
	const xdg = require_lib();
	const isWinOS = /^win/i.test(process.platform);
	function _normalizeOptions(options, isolated) {
		options = options || {};
		if (typeof options !== "object") options = { isolated: options };
		options.isolated = options.isolated === void 0 || options.isolated === null ? isolated : options.isolated;
		if (typeof options.isolated !== "boolean") throw new TypeError(`Expected boolean for "isolated" argument, got ${typeof options.isolated}`);
		return options;
	}
	const base = (name, isolated) => {
		...
		object.configDirs = (options = { isolated: null }) => {
			options = _normalizeOptions(options, isolated);
			return xdg.configDirs().map((s$1) => path.join(s$1, options.isolated ? name : ""));
		};
		object.dataDirs = (options = { isolated: null }) => {
			options = _normalizeOptions(options, isolated);
			return xdg.dataDirs().map((s$1) => path.join(s$1, options.isolated ? name : ""));
		};
		return object;
	};
	const windows = (name, isolated) => {
		...
		const tmpdir$1 = os$1.tmpdir();
		const appData = env$2.APPDATA || path.join(homedir || tmpdir$1, "AppData", "Roaming");
		const localAppData = env$2.LOCALAPPDATA || path.join(homedir || tmpdir$1, "AppData", "Local");
		const object = {};
		object.cache = (options = { isolated: null }) => {
			options = _normalizeOptions(options, isolated);
			return !options.isolated || env$2.XDG_CACHE_HOME ? path.join(xdg.cache(), options.isolated ? name : "") : path.join(localAppData, options.isolated ? name : "", "Cache");
		};
		object.config = (options = { isolated: null }) => {
			options = _normalizeOptions(options, isolated);
			return !options.isolated || env$2.XDG_CONFIG_HOME ? path.join(xdg.config(), options.isolated ? name : "") : path.join(appData, options.isolated ? name : "", "Config");
		};
		object.data = (options = { isolated: null }) => {
			options = _normalizeOptions(options, isolated);
			return !options.isolated || env$2.XDG_DATA_HOME ? path.join(xdg.data(), options.isolated ? name : "") : path.join(appData, options.isolated ? name : "", "Data");
		};
		object.runtime = (options = { isolated: null }) => {
			options = _normalizeOptions(options, isolated);
			return xdg.runtime() ? path.join(xdg.runtime(), options.isolated ? name : "") : void 0;
		...
		object.state = (options = { isolated: null }) => {
			options = _normalizeOptions(options, isolated);
			return !options.isolated || env$2.XDG_STATE_HOME ? path.join(xdg.state(), options.isolated ? name : "") : path.join(localAppData, options.isolated ? name : "", "State");
		};
		object.configDirs = (options = { isolated: null }) => {
			options = _normalizeOptions(options, isolated);
			const dirs = [object.config(options)];
			if (env$2.XDG_CONFIG_DIRS) dirs.push(...env$2.XDG_CONFIG_DIRS.split(path.delimiter).map((s$1) => path.join(s$1, options.isolated ? name : "")));
			return dirs;
		};
		object.dataDirs = (options = { isolated: null }) => {
			options = _normalizeOptions(options, isolated);
			const dirs = [object.data(options)];
			if (env$2.XDG_DATA_DIRS) dirs.push(...env$2.XDG_DATA_DIRS.split(path.delimiter).map((s$1) => path.join(s$1, options.isolated ? name : "")));
			return dirs;
		};
		return object;
	};
	var _XDGAppPaths = class _XDGAppPaths {
		constructor(options = {
			name: null,
			suffix: null,
			isolated: true
		}) {
			const XDGAppPaths = function(options$1 = {
				name: null,
				suffix: null,
				isolated: true
			}) {
				return new _XDGAppPaths(options$1);
			};
			...
			if (!name) name = path.parse(process.pkg ? process.execPath : __require.main ? __require.main.filename : process.argv[0]).name;
...
//#endregion
//#region src/util/check-latest-version.ts
init_source();
var import_xdg_app_paths = /* @__PURE__ */ __toESM(require_xdg_app_paths());
...
*/
const FETCH_TIMEOUT_MS = 1e3;
function defaultCachePath() {
	return Path.join((0, import_xdg_app_paths.default)("sandbox-cli").cache(), "latest-version.json");
}
function readCache(cachePath) {
	try {
		const parsed = JSON.parse(readFileSync(cachePath, "utf8"));
		if (typeof parsed.latest === "string" && typeof parsed.checkedAt === "number") return parsed;
	} catch {}
}
...
*/
function startLatestVersionCheck(opts = {}) {
	if (process.env.SANDBOX_SKIP_VERSION_CHECK) return { report() {} };
	...
	let controller;
	if (!(cached !== void 0 && Date.now() - cached.checkedAt < ttlMs)) {
		controller = new AbortController();
		const timeout$1 = setTimeout(() => controller?.abort(), FETCH_TIMEOUT_MS);
		timeout$1.unref?.();
		fetchImpl(REGISTRY_URL, { signal: controller.signal }).then((res) => res.ok ? res.json() : void 0).then((json) => {
			const fetched = json?.version;
			if (fetched) {
				latest = fetched;
		...
		}).catch(() => {}).finally(() => clearTimeout(timeout$1));
	}
	return { report() {
		controller?.abort();
		if (latest && isOutdated(current, latest)) process.stderr.write(source_default.yellow("⚠ ") + `A newer Sandbox CLI is available: ${source_default.cyan(latest)}` + source_default.dim(` (you're on ${current})`) + "\n" + source_default.dim("   ╰ ") + "newer versions can change creation defaults like the base image. Update with " + source_default.cyan("npm i -g sandbox@latest") + "\n");
	} };
}
/**
...
function isOutdated(current, latest) {
	...
	const c$1 = current.split(".").map(Number);
...
//#endregion
//#region src/args/region.ts
var import_cjs$17 = /* @__PURE__ */ __toESM(require_cjs());
const regionType = import_cjs$17.extendType(import_cjs$17.string, {
	displayName: "REGION",
	async from(value) {
		const region$1 = value.trim();
		if (region$1 === "") throw new Error("Region cannot be empty.");
		return region$1;
	}
});
const region = import_cjs$17.option({
	long: "region",
	type: import_cjs$17.optional(regionType),
	description: `Region to create the sandbox in (defaults to ${DEFAULT_SANDBOX_REGION}; see the Vercel docs for available regions)`
});
const regionListType = import_cjs$17.extendType(import_cjs$17.string, {
	displayName: "REGION,...",
	async from(value) {
		const regions = value.split(",").map((region$1) => region$1.trim()).filter((region$1) => region$1 !== "");
		if (regions.length === 0) throw new Error("Regions cannot be empty.");
		return [...new Set(regions)];
	}
});
const failoverRegionListType = import_cjs$17.extendType(import_cjs$17.string, {
	displayName: "REGION,...|none",
	async from(value) {
		if (value.trim() === "none") return [];
		const regions = await regionListType.from(value);
		if (regions.includes("none")) throw new Error("\"none\" cannot be combined with region names.");
		return regions;
	}
});
const failoverRegions = import_cjs$17.option({
	long: "failover-regions",
	type: import_cjs$17.optional(failoverRegionListType),
	description: "Comma-separated regions the sandbox can fail over to (e.g. --failover-regions sfo1,cle1). Must not include the sandbox region. Pass \"none\" for no failover regions, overriding the project default."
});
...
const create = import_cjs$16.command({
	...
	async handler(input) {
		const { name, nonPersistent, ports, scope: scope$1, runtime: runtime$1, image, timeout: timeout$1, vcpus: vcpus$1, silent, snapshot: snapshot$1, connect: connect$1, envVars, tags, region: region$1, failoverRegions: failoverRegions$1, snapshotExpiration: snapshotExpiration$1, keepLastSnapshots: keepLastSnapshots$1, keepLastSnapshotsFor: keepLastSnapshotsFor$1, deleteEvictedSnapshots: deleteEvictedSnapshots$1, networkPolicy: networkPolicyMode$1, allowedDomains: allowedDomains$1, allowedCIDRs: allowedCIDRs$1, deniedCIDRs: deniedCIDRs$1 } = input;
		const { __printConnectHint = true } = input;
		if (runtime$1 !== void 0 && image !== void 0) throw new Error("--runtime and --image cannot be used together.");
		const versionCheck = silent ? void 0 : startLatestVersionCheck();
		...
		const sandbox = snapshot$1 ? await sandboxClient.create({
			...
			tags: tagsObj,
			region: region$1,
			failoverRegions: failoverRegions$1,
			persistent,
		...
		if (!silent) {
			printSandboxSummary({
				...
				scope: scope$1,
				action: "created",
				connectHint: !connect$1 && __printConnectHint
			});
			versionCheck?.report();
		}
...
const fork = import_cjs$14.command({
	...
	async handler({ source, name, nonPersistent, ports, scope: scope$1, timeout: timeout$1, vcpus: vcpus$1, silent, connect: connect$1, envVars, tags, region: region$1, failoverRegions: failoverRegions$1, snapshotExpiration: snapshotExpiration$1, keepLastSnapshots: keepLastSnapshots$1, keepLastSnapshotsFor: keepLastSnapshotsFor$1, deleteEvictedSnapshots: deleteEvictedSnapshots$1, networkPolicy: networkPolicyMode$1, allowedDomains: allowedDomains$1, allowedCIDRs: allowedCIDRs$1, deniedCIDRs: deniedCIDRs$1 }) {
		...
		const sandbox = await sandboxClient.fork({
			...
			...region$1 !== void 0 && { region: region$1 },
			...failoverRegions$1 !== void 0 && { failoverRegions: failoverRegions$1 },
...
const list = import_cjs$12.command({
	...
	async handler({ scope: { token: token$1, team: team$1, project: project$1 }, all, namePrefix, sortBy, sortOrder, tags, limit, cursor }) {
		...
		const columns = {
			...
			REGION: { value: (s$1) => s$1.region ?? DEFAULT_SANDBOX_REGION },
...
const parseLocalOrRemotePath = async (input) => {
	...
	if (parts.length === 2) {
		const [id, path$2] = parts;
		if (!id || !path$2) throw new Error([
	...
	async handler({ scope: { token: token$1, team: team$1, project: project$1 }, name, sortOrder, limit, cursor }) {
		...
		console.log(table({
			...
			columns: {
				...
				REGIONS: { value: (s$1) => s$1.regions?.length ? s$1.regions.join(", ") : s$1.region },
	...
	async handler({ scope: { token: token$1, team: team$1, project: project$1 }, snapshotId: id }) {
		...
		console.log(table({
			...
			columns: {
				...
				EXPIRATION: { value: (s$1) => s$1.status === "deleted" ? source_default.gray.dim("deleted") : timeAgo(s$1.expiresAt) },
				SIZE: { value: (s$1) => formatBytes(s$1.sizeBytes) },
				REGIONS: { value: (s$1) => s$1.regions.join(", ") },
				["SOURCE SESSION"]: { value: (s$1) => s$1.sourceSessionId }
			}
		}));
	}
...
const regionCommand = import_cjs$1.command({
	name: "region",
	...
	args: {
		...
		region: import_cjs$1.positional({
			type: regionType,
			description: "Region to run the sandbox in"
		}),
		scope
	},
	async handler({ scope: { token: token$1, team: team$1, project: project$1 }, sandbox: name, region: region$1 }) {
		const sandbox = await sandboxClient.get({
			name,
			projectId: project$1,
			teamId: team$1,
		...
		const spinner = ora("Updating sandbox configuration...").start();
		try {
			await sandbox.update({ region: region$1 });
			spinner.stop();
			process.stderr.write("✅ Configuration updated for sandbox " + source_default.cyan(name) + "\n");
			process.stderr.write(source_default.dim("   ╰ ") + "region: " + source_default.cyan(region$1) + "\n");
		} catch (error) {
			spinner.stop();
			throw error;
		}
...
const failoverRegionsCommand = import_cjs$1.command({
	...
	args: {
		...
		failoverRegions: import_cjs$1.positional({
	...
	async handler({ scope: { token: token$1, team: team$1, project: project$1 }, sandbox: name, failoverRegions: failoverRegions$1 }) {
		const sandbox = await sandboxClient.get({
			name,
			projectId: project$1,
			teamId: team$1,
		...
		const spinner = ora("Updating sandbox configuration...").start();
		try {
			await sandbox.update({ failoverRegions: failoverRegions$1 });
			spinner.stop();
			const display = failoverRegions$1.length === 0 ? "cleared" : failoverRegions$1.join(", ");
			process.stderr.write("✅ Configuration updated for sandbox " + source_default.cyan(name) + "\n");
			process.stderr.write(source_default.dim("   ╰ ") + "failover-regions: " + source_default.cyan(display) + "\n");
		} catch (error) {
			spinner.stop();
			throw error;
		}
...
//#endregion
export { init_source as a, require_cjs as i, printTopLevelError as n, source_default as o, StyledError as r, source_exports as s, app as t };
//# sourceMappingURL=app-6Yn0z5a0.mjs.map