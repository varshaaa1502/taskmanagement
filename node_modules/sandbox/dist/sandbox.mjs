...
import { a as init_source, i as require_cjs, n as printTopLevelError, o as source_default, r as StyledError, s as source_exports, t as app } from "./app-6Yn0z5a0.mjs";
...
function steerShCommand(args) {
	...
	throw new StyledError([
		...
		`${source_default.bold("hint:")} to run ${source_default.cyan(example)} interactively in a new sandbox:`,
