...
import{require_source}from"./chunk-U7KCDTCH.js";import{__toESM}from"./chunk-6L236MNA.js";var import_chalk=__toESM(require_source(),1),packageName="vercel",logo="\u25B2",help=()=>`
  ...
  ${import_chalk.default.dim("Commands:")}
    ...
    ${import_chalk.default.dim("Basic")}
      ...
      deploy               [path]      Performs a deployment ${import_chalk.default.bold("(default)")}
    ...
    ${import_chalk.default.dim("Advanced")}
      ...
      storage              [cmd]       Connect and manage storage resources for your Projects
  ...
  ${import_chalk.default.dim("Global Options:")}
    ...
    -A ${import_chalk.default.bold.underline("FILE")}, --local-config=${import_chalk.default.bold.underline("FILE")}   Path to the local \`vercel.json\` file
    -Q ${import_chalk.default.bold.underline("DIR")}, --global-config=${import_chalk.default.bold.underline("DIR")}    Path to the global \`.vercel\` directory
    -d, --debug                    Debug mode [off]
    --no-color                     No color mode [off]
    --non-interactive              Run without interactive prompts (default when agent detected)
    -S, --scope                    Set a custom scope
    -t ${import_chalk.default.underline("TOKEN")}, --token=${import_chalk.default.underline("TOKEN")}        Login token
  ...
  ${import_chalk.default.gray("\u2013")} Show the usage information for the sub command ${import_chalk.default.dim("`list`")}
